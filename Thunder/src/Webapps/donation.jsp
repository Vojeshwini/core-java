...
<form action="feedback" method="post">
    ...
    <div class="mb-3">
        <label for="exampleInputPassword3" class="form-label">Amount</label>
        <div class="d-flex justify-content-center">
            <input type="number" name="amount" placeholder="Amount" class="form-control" id="exampleInputPassword3" style="width: 500px;" name="type">
        </div>
    </div>
